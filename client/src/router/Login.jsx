        ...
        <div className='w-full h-100'>
          ...
          <form className='mt-6' action="#" method='POST'>
            <div>
                ...
                <input type="text" placeholder='Username'className='w-full  text-black focus:bg-white-700 focus:outline-black bg-white-700 mt-2 border rounded-lg ' autoComplete='true' autoFocus required />
            </div>
            <div className='mt-4'>
                <label htmlFor="password">Password</label>
                <input type="password" minLength={8} placeholder='password' name='' className='w-full text-black focus:bg-white-700 foucs:outline-black bg-white-700 mt-2 border rounded-lg'autoComplete='true' required/>
            </div>
